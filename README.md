...
- The data for each is stored in its respective csv file. Note: data only contains 'DISTANCE', 'START LAT', 'START LONG', 'END LAT', 'END LONG' right now, can update this later if needed!
